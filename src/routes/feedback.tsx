          ...
          {feedbacks.map((feed) => (
            ...
            >
              ...
              <AccordionContent className="px-5 py-6 bg-white rounded-b-lg space-y-5 shadow-inner">
                {/* You can render answer/feedback details here */}
                <div className="text-lg font-semibold to-gray-700">
                  <Star className="inline mr-2 text-yellow-400" />
                  Rating : {feed.rating}
                </div>

                <Card className="border-none space-y-3 p-4 bg-green-50 
                ...
                <Card className="border-none space-y-3 p-4 bg-yellow-50 
                rounded-lg shadow-md">
                 <CardTitle className="flex items-center text-lg">
                ...
                <Card className="border-none space-y-3 p-4 bg-purple-50 
                rounded-lg shadow-md">
                 <CardTitle className="flex items-center text-lg">
